   ...
   <div class="box">
      <div class="box-header with-border">
         ...
         <div class="box-tools pull-right">
            <a href="index.php?page=kelola_kelas_tambah" class="btn btn-primary btn-sm" title="Tambah Kelas"
      ...
      <div class="box-body">
         <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3">
               <form action="index.php?page=kelola_kelas&q=<?= isset($_GET['q']) ? $_GET['q'] : '' ?>&halaman=<?= isset($_GET['halaman']) ? $_GET['halaman'] : '' ?>" method="get">
                  <div class="input-group">
                     <input type="hidden" name="page" value="kelola_kelas">
                     <input type="hidden" name="q" value="<?= isset($_GET['q']) ? $_GET['q'] : '' ?>">
         ...
         <table class="table table-bordered table-striped">
            ...
            ?>
               <tr>
                  ...
                  <td>
                     <a href="index.php?page=kelola_kelas_edit&kode_kelas=<?= $result['kode_kelas'] ?>"
                        data-toggle="tooltip" data-placement="top" 
                     class="btn btn-warning btn-sm" title="Edit Kelas">
                        <i class="fa fa-edit
                        "></i>
                     </a>
                     <a 
                     onclick="return swal({
                        ...
                        window.location.href='index.php?page=kelola_kelas_hapus&kode_kelas=<?= $result['kode_kelas'] ?>'
                     })"

               
                        data-toggle="tooltip" data-placement="top"
                     
                     class="btn btn-danger btn-sm" title="Hapus Kelas">
                        <i class="fa fa-trash"></i>
                     </a>
                     <a href="index.php?page=kelola_kelas_siswa&kode_kelas=<?= $result['kode_kelas'] ?>"
                        data-toggle="tooltip" data-placement="top"
                     class="btn btn-info btn-sm" title="Kelola Anggota Kelas">
                        <i class="fa fa-users"></i> Kelola Anggota Kelas
                     </a>
                  </td>
               </tr>
               <?php } ?>
            ...
            <div class="col-md-12">
               <nav aria-label="Page navigation">
                  ...
                  ">
                     ...
                     ?>
                     <li>
                        <a href="index.php?page=kelola_kelas&halaman=<?= $prev ?>&q=<?= isset($_GET['q']) ? $_GET['q'] : '' ?>&jurusan=<?= isset($_GET['jurusan']) ? $_GET['jurusan'] : '' ?>&tahun_ajaran=<?= isset($_GET['tahun_ajaran']) ? $_GET['tahun_ajaran'] : '' ?>"
                     ...
                     <?php for ($i=1; $i <= $total; $i++) { ?>
                      ...
                      ><a href="index.php?page=kelola_kelas&halaman=<?= $i ?>&q=<?= isset($_GET['q']) ? $_GET['q'] : '' ?>&jurusan=<?= isset($_GET['jurusan']) ? $_GET['jurusan'] : '' ?>&tahun_ajaran=<?= isset($_GET['tahun_ajaran']) ? $_GET['tahun_ajaran'] : '' ?>"
                           data-toggle="tooltip" data-placement="top"
                           title="Halaman <?= $i ?>"
                      ><?= $i ?></a></li>
                     <?php } ?>
                     ...
                     ?>
                     <li>
                        <a href="index.php?page=kelola_kelas&halaman=<?= $next ?>&q=<?= isset($_GET['q']) ? $_GET['q'] : '' ?>&jurusan=<?= isset($_GET['jurusan']) ? $_GET['jurusan'] : '' ?>&tahun_ajaran=<?= isset($_GET['tahun_ajaran']) ? $_GET['tahun_ajaran'] : '' ?>"
                           data-toggle="tooltip" data-placement="top"
                           title="Halaman <?= $next ?>"
                        aria-label="Next">
